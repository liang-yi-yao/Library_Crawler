...
public class HttpWangyiyun {
    ...
    public void commentAPI() throws Exception {
        ...
        //字符填充
        encSecKey= HttpWangyiyun.zfill(encSecKey, 256);
        //评论获取
        Document document = Jsoup.connect("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1446245865?csrf_token=").cookie("appver", "1.5.0.75771")
                .header("Referer", "http://music.163.com/").data("params", params).data("encSecKey", encSecKey)
                .ignoreContentType(true).post();
        System.out.println("参数一：" +params);
        System.out.println("参数二：" +encSecKey);
        System.out.println("评论：" + document.text());
    }

	
	public static void main(String[] args) throws Exception{
		HttpWangyiyun pp=new HttpWangyiyun();
		pp.commentAPI();
